class programa:
    ...
    def calculocapacidaddepago(self):
        ...
        calculocapacidaddepago = (((salariobruto) - (self.tienecreditos(self) + self.tienetarjetas(self) - self.calculocuota(self)))/(salarioliquido))*100
        return print("\n La capacidad de pago es ", calculocapacidaddepago, "porciento.")
